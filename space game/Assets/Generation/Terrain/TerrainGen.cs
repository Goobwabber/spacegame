...
namespace Generation
{
    public class TerrainGen : MonoBehaviour
    {
        ...
        static public void AddTerrainToQueue(Transform planetObject, Vector3 position, int seed, bool randomSeed, Style terrainStyle, float seaLevel, GenerationData[] generationData, ColorHeight[] colorHeight, PopulateData[] population, Material material, Material seaMaterial, float radius, int subdivisions, int chunckSubdivisions)
        {
