...
namespace Generation
{
    public class Polygon
    {
        ...
        private MeshData TriangleToStair(Vector3[] triangle)
        {
            ...
            for (int h = h_min; h <= h_max; h++)
            {
                ...
                foreach(var item in colorHeight) {
                    ...
                    color = colorHeight[new System.Random().Next(0, colorHeight.Length)].color;
                }
        ...
        public Polygon(int a, int b, int c, ref TerrainGen planet)
        {
        ...
        public void GenerateMesh()
        {
            ...
            for (int x = 0; x < size; x++)
            {
                ...
                {
                    if (TerrainGen.ThreadNeedToQuit())
                        return;
                    ...
                    if(planet.GetStyle() == Style.LowPoly)
                    {
                        ...
                        if (!planet.GetColoring()) {
                            ...
                            color1 = colorHeight[new System.Random().Next(0, colorHeight.Length)].color;
                            color2 = colorHeight[new System.Random().Next(0, colorHeight.Length)].color;
                            color3 = colorHeight[new System.Random().Next(0, colorHeight.Length)].color;
                        }
