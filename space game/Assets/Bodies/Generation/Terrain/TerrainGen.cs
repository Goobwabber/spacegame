...
namespace Generation
{
    public class TerrainGen : MonoBehaviour
    {
        ...
        /// </summary>
        /// <param name="planetObject">The planet object that will hold the terrain objects</param>
        ...
        static public void AddTerrainToQueue(Transform planetObject, Vector3 position, int seed, bool randomSeed, Style terrainStyle, float seaLevel, GenerationData[] generationData, ColorHeight[] colorHeight, PopulateData[] population, Material material, Material seaMaterial, bool randomColoring, float radius, int subdivisions, int chunckSubdivisions)
        {
            // Instantiate a gameobject that holds terrain.
            GameObject obj = new GameObject();
            obj.name = "Terrain";
            obj.transform.parent = planetObject;
        ...
        /// <param name="subdivisions">Icosphere subdivisions.</param>
        /// <param name="chunckSubdivisions">Chunck subdivisions.</param>
        private void InstantiatePlanetVariables(int seed, Style terrainStyle, float seaLevel, GenerationData[] generationData, ColorHeight[] colorHeight, PopulateData[] population, Material material, Material seaMaterial, bool randomColoring, float radius, int subdivisions, int chunckSubdivisions)
        {
            this.seed = seed;
        ...
        /// <summary>
        /// Get the coloring type.
        /// </summary>
        /// <returns> Return the planet coloring type.</returns>
